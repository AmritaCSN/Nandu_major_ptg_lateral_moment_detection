...
Usage:
python subsample.py --in outputs/data/labeled.parquet --out outputs/data/labeled_small.parquet --neg 2000000
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="inp", default="outputs/data/labeled.parquet")
    ap.add_argument("--out", default="outputs/data/labeled_small.parquet")
